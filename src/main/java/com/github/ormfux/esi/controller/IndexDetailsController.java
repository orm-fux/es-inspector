...
public class IndexDetailsController extends AbstractQueryTemplateController {
    ...
    public ESSearchResult search(final String query) {
        ...
        return new ESSearchResult(esResponse, resultTransformService.createJsonFXTree(esResponse, 3, 3), resultTransformService.createTable(esResponse));
    }
    ...
    public ESSearchResult searchDocument(final String documentId) {
        ...
        return new ESSearchResult(esResponse, resultTransformService.createJsonFXTree(esResponse, 300, 300), resultTransformService.createTable(esResponse));
    }
